...
var renderType_PhotoShowroomPage_Host:import0.RenderComponentType = (null as any);
class _View_PhotoShowroomPage_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _PhotoShowroomPage_0_4:import3.PhotoShowroomPage;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_PhotoShowroomPage_Host0,renderType_PhotoShowroomPage_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('ng-component',rootSelector,(null as any));
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_PhotoShowroomPage0(this.viewUtils,this.injector(0),this._appEl_0);
    ...
    compView_0.create(this._PhotoShowroomPage_0_4,this.projectableNodes,(null as any));
    this.init([].concat([this._el_0]),[this._el_0],[],[]);
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.PhotoShowroomPage) && (0 === requestNodeIndex))) { return this._PhotoShowroomPage_0_4; }
    return notFoundResult;
  }
}
function viewFactory_PhotoShowroomPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_PhotoShowroomPage_Host === (null as any))) { (renderType_PhotoShowroomPage_Host = viewUtils.createRenderComponentType('',0,import11.ViewEncapsulation.None,[],{})); }
  return new _View_PhotoShowroomPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const PhotoShowroomPageNgFactory:import12.ComponentFactory<import3.PhotoShowroomPage> = new import12.ComponentFactory<import3.PhotoShowroomPage>('ng-component',viewFactory_PhotoShowroomPage_Host0,import3.PhotoShowroomPage);
const styles_PhotoShowroomPage:any[] = [];
var renderType_PhotoShowroomPage:import0.RenderComponentType = (null as any);
class _View_PhotoShowroomPage0 extends import1.AppView<import3.PhotoShowroomPage> {
  _el_0:any;
  ...
  _text_3:any;
  _el_4:any;
  _MenuToggle_4_3:import15.MenuToggle;
  _ToolbarItem_4_4:import16.ToolbarItem;
  ...
  /*private*/ _expr_9:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_PhotoShowroomPage0,renderType_PhotoShowroomPage,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._MenuToggle_4_3 = new import15.MenuToggle(this.parentInjector.get(import28.MenuController),new import24.ElementRef(this._el_4),this.parentInjector.get(import25.ViewController,(null as any)),this._Navbar_2_4);
    this._ToolbarItem_4_4 = new import16.ToolbarItem(this.parentInjector.get(import23.Config),new import24.ElementRef(this._el_4),this.renderer,this.parentInjector.get(import13.Toolbar,(null as any)),this._Navbar_2_4);
    ...
    this._ToolbarTitle_9_4 = new import19.ToolbarTitle(this.parentInjector.get(import23.Config),new import24.ElementRef(this._el_9),this.renderer,this.parentInjector.get(import13.Toolbar,(null as any)),this._Navbar_2_4);
    this._appEl_9.initComponent(this._ToolbarTitle_9_4,[],compView_9);
    this._text_10 = this.renderer.createText((null as any),'Photos',(null as any));
    ...
    var compView_16:any = import30.viewFactory_Content0(this.viewUtils,this.injector(16),this._appEl_16);
    ...
    this._el_18 = this.renderer.createElement((null as any),'ion-slides',(null as any));
    this._appEl_18 = new import2.AppElement(18,16,this,this._el_18);
    var compView_18:any = import34.viewFactory_Slides0(this.viewUtils,this.injector(18),this._appEl_18);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import15.MenuToggle) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 7)))) { return this._MenuToggle_4_3; }
    if (((token === import16.ToolbarItem) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 7)))) { return this._ToolbarItem_4_4; }
    ...
    if (((token === import21.Slides) && ((18 <= requestNodeIndex) && (requestNodeIndex <= 21)))) { return this._Slides_18_4; }
    if (((token === import20.Content) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 22)))) { return this._Content_16_4; }
    if (((token === import20.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 23)))) { return this._Content_14_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    changes = (null as any);
    const currVal_9:any = this.context.images;
    ...
    const currVal_4:any = this._MenuToggle_4_3.isHidden;
    ...
    const currVal_8:any = this._Content_16_4._sbPadding;
  ...
  private _handle_click_4_0($event:any):boolean {
    ...
    const pd_0:any = ((<any>this._MenuToggle_4_3.toggle()) !== false);
    return (true && pd_0);
  }
}
export function viewFactory_PhotoShowroomPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.PhotoShowroomPage> {
  if ((renderType_PhotoShowroomPage === (null as any))) { (renderType_PhotoShowroomPage = viewUtils.createRenderComponentType('/home/nicolas/projects/cloudtripper/cloudtripper-frontend/.tmp/pages/photo-showroom/photo-showroom.html',0,import11.ViewEncapsulation.None,styles_PhotoShowroomPage,{})); }
  return new _View_PhotoShowroomPage0(viewUtils,parentInjector,declarationEl);
}
class _View_PhotoShowroomPage1 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _Slide_0_4:import21.Slide;
  _text_1:any;
  _el_2:any;
  _text_3:any;
  /*private*/ _expr_0:any;
  /*private*/ _expr_2:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_PhotoShowroomPage1,renderType_PhotoShowroomPage,import6.ViewType.EMBEDDED,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = import34.viewFactory_Slide0(this.viewUtils,this.injector(0),this._appEl_0);
    this._Slide_0_4 = new import21.Slide(new import24.ElementRef(this._el_0),(<_View_PhotoShowroomPage0>this.parent)._Slides_18_4);
    ...
    var disposable_0:Function = this.renderer.listen(this._el_2,'tap',this.eventHandler(this._handle_tap_2_0.bind(this)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import21.Slide) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._Slide_0_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
  ...
  private _handle_tap_2_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.parent.context.showPhoto(this.context.$implicit)) !== false);
    return (true && pd_0);
  }
}
function viewFactory_PhotoShowroomPage1(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
