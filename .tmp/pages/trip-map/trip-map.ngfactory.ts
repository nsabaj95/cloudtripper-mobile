...
var renderType_TripMapPage_Host:import0.RenderComponentType = (null as any);
class _View_TripMapPage_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _LogsService_0_4:import3.LogsService;
  _TripMapPage_0_5:import4.TripMapPage;
  constructor(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement) {
    super(_View_TripMapPage_Host0,renderType_TripMapPage_Host,import7.ViewType.HOST,viewUtils,parentInjector,declarationEl,import8.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('ng-component',rootSelector,(null as any));
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_TripMapPage0(this.viewUtils,this.injector(0),this._appEl_0);
    ...
    compView_0.create(this._TripMapPage_0_5,this.projectableNodes,(null as any));
    this.init([].concat([this._el_0]),[this._el_0],[],[]);
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.LogsService) && (0 === requestNodeIndex))) { return this._LogsService_0_4; }
    if (((token === import4.TripMapPage) && (0 === requestNodeIndex))) { return this._TripMapPage_0_5; }
    return notFoundResult;
  }
}
function viewFactory_TripMapPage_Host0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_TripMapPage_Host === (null as any))) { (renderType_TripMapPage_Host = viewUtils.createRenderComponentType('',0,import14.ViewEncapsulation.None,[],{})); }
  return new _View_TripMapPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const TripMapPageNgFactory:import15.ComponentFactory<import4.TripMapPage> = new import15.ComponentFactory<import4.TripMapPage>('ng-component',viewFactory_TripMapPage_Host0,import4.TripMapPage);
const styles_TripMapPage:any[] = [];
var renderType_TripMapPage:import0.RenderComponentType = (null as any);
class _View_TripMapPage0 extends import1.AppView<import4.TripMapPage> {
  ...
  _Content_14_4:import24.Content;
  _text_15:any;
  _el_16:any;
  _text_17:any;
  _text_18:any;
  ...
  /*private*/ _expr_7:any;
  constructor(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement) {
    super(_View_TripMapPage0,renderType_TripMapPage,import7.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import8.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Header_0_3 = new import17.Header(this.parentInjector.get(import25.Config),new import26.ElementRef(this._el_0),this.renderer,this.parentInjector.get(import27.ViewController,(null as any)));
    ...
    this._Navbar_2_4 = new import18.Navbar(this.parentInjector.get(import29.App),this.parentInjector.get(import27.ViewController,(null as any)),this.parentInjector.get(import11.NavController,(null as any)),this.parentInjector.get(import25.Config),new import26.ElementRef(this._el_2),this.renderer);
    ...
    this._MenuToggle_4_5 = new import20.MenuToggle(this.parentInjector.get(import31.MenuController),new import26.ElementRef(this._el_4),this.parentInjector.get(import27.ViewController,(null as any)),this._Navbar_2_4);
    this._ToolbarItem_4_6 = new import21.ToolbarItem(this.parentInjector.get(import25.Config),new import26.ElementRef(this._el_4),this.renderer,this.parentInjector.get(import17.Toolbar,(null as any)),this._Navbar_2_4);
    ...
    var compView_9:any = import32.viewFactory_ToolbarTitle0(this.viewUtils,this.injector(9),this._appEl_9);
    this._ToolbarTitle_9_4 = new import23.ToolbarTitle(this.parentInjector.get(import25.Config),new import26.ElementRef(this._el_9),this.renderer,this.parentInjector.get(import17.Toolbar,(null as any)),this._Navbar_2_4);
    this._appEl_9.initComponent(this._ToolbarTitle_9_4,[],compView_9);
    this._text_10 = this.renderer.createText((null as any),'Trip map',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import24.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._Content_14_4; }
    return notFoundResult;
  }
...
export function viewFactory_TripMapPage0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<import4.TripMapPage> {
  if ((renderType_TripMapPage === (null as any))) { (renderType_TripMapPage = viewUtils.createRenderComponentType('/home/nicolas/projects/cloudtripper/cloudtripper-frontend/.tmp/pages/trip-map/trip-map.html',0,import14.ViewEncapsulation.None,styles_TripMapPage,{})); }
